...
(function (root) {
    ...
    const DEFAULT_BLOCKS = [
        ...
        { id: 'met-avg-generation-tps', x: 0, y: 66, w: 6, h: 30 },
        { id: 'met-avg-prefill-tps', x: 6, y: 66, w: 6, h: 30 },
        { id: 'met-rate-completion-tokens-s', x: 12, y: 66, w: 6, h: 30 },
        { id: 'met-rate-prompt-tokens-s', x: 18, y: 66, w: 6, h: 30 },
        { id: 'met-rate-requests-s', x: 0, y: 97, w: 6, h: 30 },
        { id: 'met-cache-efficiency', x: 6, y: 97, w: 6, h: 30 },
        { id: 'met-engines-active-requests', x: 12, y: 97, w: 6, h: 30 },
        { id: 'met-mem-percent', x: 18, y: 97, w: 6, h: 30 },
        { id: 'met-mem-used-bytes', x: 0, y: 128, w: 6, h: 30 },
        { id: 'met-cache-total-bytes', x: 6, y: 128, w: 6, h: 30 },
